 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_change_tail)(struct __sk_buff *skb, __u32 len,
                                   __u64 flags) = (void *)38;
 ...
 * 	failure.
 */
static __s64 (*bpf_csum_update)(struct __sk_buff *skb,
                                __wsum csum) = (void *)40;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_change_head)(struct __sk_buff *skb, __u32 len,
                                   __u64 flags) = (void *)43;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_adjust_head)(struct xdp_md *xdp_md,
                                   int delta) = (void *)44;
 ...
 */
static long (*bpf_sk_redirect_map)(struct __sk_buff *skb, void *map, __u32 key,
                                   __u64 flags) = (void *)52;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_sock_map_update)(struct bpf_sock_ops *skops, void *map,
                                   void *key, __u64 flags) = (void *)53;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_adjust_meta)(struct xdp_md *xdp_md,
                                   int delta) = (void *)54;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_perf_event_read_value)(void *map, __u64 flags,
 ...
 * 	as required).
 */
static long (*bpf_sock_ops_cb_flags_set)(struct bpf_sock_ops *bpf_sock,
                                         int argval) = (void *)59;
 ...
 * 	**SK_PASS** on success, or **SK_DROP** on error.
 */
static long (*bpf_msg_redirect_map)(struct sk_msg_md *msg, void *map, __u32 key,
                                    __u64 flags) = (void *)60;
 ...
 * 	0
 */
static long (*bpf_msg_apply_bytes)(struct sk_msg_md *msg,
                                   __u32 bytes) = (void *)61;
 ...
 * 	0
 */
static long (*bpf_msg_cork_bytes)(struct sk_msg_md *msg,
                                  __u32 bytes) = (void *)62;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_msg_pull_data)(struct sk_msg_md *msg, __u32 start, __u32 end,
                                 __u64 flags) = (void *)63;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_adjust_tail)(struct xdp_md *xdp_md,
                                   int delta) = (void *)65;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_get_xfrm_state)(struct __sk_buff *skb, __u32 index,
 ...
 */
static long (*bpf_fib_lookup)(void *ctx, struct bpf_fib_lookup *params,
                              int plen, __u32 flags) = (void *)69;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_sock_hash_update)(struct bpf_sock_ops *skops, void *map,
                                    void *key, __u64 flags) = (void *)70;
 ...
 * 	**SK_PASS** on success, or **SK_DROP** on error.
 */
static long (*bpf_msg_redirect_hash)(struct sk_msg_md *msg, void *map,
                                     void *key, __u64 flags) = (void *)71;
 ...
 * 	**SK_PASS** on success, or **SK_DROP** on error.
 */
static long (*bpf_sk_redirect_hash)(struct __sk_buff *skb, void *map, void *key,
                                    __u64 flags) = (void *)72;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_lwt_push_encap)(struct __sk_buff *skb, __u32 type, void *hdr,
                                  __u32 len) = (void *)73;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_lwt_seg6_adjust_srh)(struct __sk_buff *skb, __u32 offset,
                                       __s32 delta) = (void *)75;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_lwt_seg6_action)(struct __sk_buff *skb, __u32 action,
                                   void *param, __u32 param_len) = (void *)76;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_sk_select_reuseport)(struct sk_reuseport_md *reuse, void *map,
                                       void *key, __u64 flags) = (void *)82;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_msg_push_data)(struct sk_msg_md *msg, __u32 start, __u32 len,
                                 __u64 flags) = (void *)90;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_msg_pop_data)(struct sk_msg_md *msg, __u32 start, __u32 len,
                                __u64 flags) = (void *)91;
 ...
 * 	error otherwise.
 */
static long (*bpf_tcp_check_syncookie)(struct bpf_sock *sk, void *iph,
 ...
 */
static long (*bpf_sysctl_get_name)(struct bpf_sysctl *ctx, char *buf,
 ...
 */
static long (*bpf_sysctl_get_new_value)(struct bpf_sysctl *ctx, char *buf,
                                        unsigned long buf_len) = (void *)103;
 ...
 * 	**-EINVAL** if sysctl is being read.
 */
static long (*bpf_sysctl_set_new_value)(struct bpf_sysctl *ctx, const char *buf,
 ...
 */
static long (*bpf_strtol)(const char *buf, unsigned long buf_len, __u64 flags,
                          long *res) = (void *)105;
 ...
 * 	**-ERANGE** if resulting value was out of range.
 */
static long (*bpf_strtoul)(const char *buf, unsigned long buf_len, __u64 flags,
 ...
 */
static void *(*bpf_sk_storage_get)(void *map, struct bpf_sock *sk, void *value,
 ...
 */
static long (*bpf_sk_storage_delete)(void *map,
                                     struct bpf_sock *sk) = (void *)108;
 ...
 */
static __s64 (*bpf_tcp_gen_syncookie)(struct bpf_sock *sk, void *iph,
                                      __u32 iph_len, struct tcphdr *th,
 ...
 *
 * 	Returns 0 on success, values for *pid* and *tgid* as seen from the
 * current *namespace* will be returned in *nsdata*.
 *
 * Returns
 ...
 * 	(reuseport).
 */
static long (*bpf_sk_assign)(void *ctx, struct bpf_sock *sk,
                             __u64 flags) = (void *)124;
 ...
 * memory fails, the string for **%s** will be an empty string, and the ip
 * 	address for **%p{i,I}{4,6}** will be 0. Not returning error to
 * 	bpf program is consistent with what **bpf_trace_printk**\ () does for
 * now.
 *
 * Returns
 * 	0 on success, or a negative error in case of failure:
 ...
 * again.
 */
static long (*bpf_seq_printf)(struct seq_file *m, const char *fmt,
                              __u32 fmt_size, const void *data,
 ...
 * again.
 */
static long (*bpf_seq_write)(struct seq_file *m, const void *data,
                             __u32 len) = (void *)127;
 ...
 * 	The id is returned or 0 in case the id could not be retrieved.
 */
static __u64 (*bpf_sk_ancestor_cgroup_id)(struct bpf_sock *sk,
...
static long (*bpf_get_task_stack)(struct task_struct *task, void *buf,
                                  __u32 size, __u64 flags) = (void *)141;
