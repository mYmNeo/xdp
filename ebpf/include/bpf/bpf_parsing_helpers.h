...
#ifndef __BPF_PARSING_HELPERS_H
#define __BPF_PARSING_HELPERS_H
...
/*
 * Swaps destination and source port in tcp header
 */
static __always_inline void swap_src_dst_tcp_port(struct tcphdr *tcphdr) {
